            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)} className="feedbackForm">
                            ...
                            <Row className="form-group" style={{"align-items": "center"}}>
