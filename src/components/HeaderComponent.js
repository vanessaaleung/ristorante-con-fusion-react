// set up header, contains a uncontrolled form
...
class Header extends Component {
  ...
  constructor(props){
    ...
    // pointing the toggleNav variable to the toggleNav function
              ...
              <Nav navbar>
                ...
                <NavItem>
                  <NavLink className="nav-link" to="/contactus">
                    <span className="fa fa-address-book-o fa-lg"></span>&nbsp;&nbsp;Contact Us
                  </NavLink>
                </NavItem>
              </Nav>
        ...
        <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
          ...
          <ModalBody>
            <Form onSubmit={this.handleLogin}>
              ...
              <Button type="submit" value="submit" className="bg-login">Login</Button>
            </Form>
          </ModalBody>
        </Modal>
      </React.Fragment>
